...
const serverSchema = z.object({
  ...
  OPENROUTER_DEFAULT_MODEL: z.string().default("anthropic/claude-haiku-4.5"),
  OPENROUTER_ALLOCATOR_MODEL: z.string().default("anthropic/claude-sonnet-4.6"),
  OPENROUTER_NARRATOR_MODEL: z.string().default("meta-llama/llama-3.1-70b-instruct"),
